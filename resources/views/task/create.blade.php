    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-12 col-xl-10">
        ...
        <div class="card mask-custom gradient-custom-2">
          ...
          <form action="{{url('task/create-task')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row mb-4">
                ...
                <div class="col">
                  <div class="form-outline">
                      ...
                      <input type="text" id="form6Example2" name="task_title" class="form-control" />
                  </div>
                </div>
            </div>
            <!-- Message input -->
            <div class="form-outline mb-4">
                ...
                <textarea class="form-control" id="form6Example7" name="task_contents" rows="4"></textarea>
            </div>
