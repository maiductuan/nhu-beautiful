            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{url('blog/add')}}" method="post" enctype="multipart/form-data">
                      <input type="hidden" id="_token" name="_token" value="{{ csrf_token() }}"/>
                      <div class="form-group">
                        <label for="exampleInputName1">Tiêu đề bài viết</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="blog_title" placeholder="title">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" name="blog_contents" rows="4"></textarea>
                      </div>
