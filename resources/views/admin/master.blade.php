          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{url('template/list')}}">Danh sách</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{url('template/add')}}">Thêm mới</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#general-like">
                <span class="menu-title">Service</span>
                <i class="menu-arrow"></i>
                <i class="mdi mdi-format-list-bulleted menu-icon"></i>
              </a>
              <div class="collapse" id="general-like">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{url('service-facebook/like-order-all')}}">Danh sách đơn</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-user">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{url('/user')}}">Danh sách</a></li>
                  <li class="nav-item"> <a class="nav-link" href="{{url('user/add')}}">Thêm mới</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
